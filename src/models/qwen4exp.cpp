...
void llama_model_qwen4exp::load_arch_hparams(llama_model_loader & ml) {
    ...
    // upstream sets n_embd_out_impl = dsv4_hc_mult*n_embd here, but t_embd is the mixed
    // [n_embd, T] stream out of build_hc_mix, so every embeddings path would over-read it
    // by dsv4_hc_mult. Leave n_embd_out() == n_embd; only --embeddings is affected.
