...
class MODEL_TENSOR(IntEnum):
    ...
    INDEXER_Q_PROJ       = auto() # qwen4exp
    INDEXER_K_PROJ       = auto() # qwen4exp
    INDEXER_Q_NORM       = auto() # qwen4exp
    # vision
    V_MMPROJ             = auto()
    V_MMPROJ_FC          = auto()
    V_MMPROJ_MLP         = auto()
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    MODEL_TENSOR.INDEXER_Q_PROJ:            "blk.{bid}.indexer.q_proj",       # qwen4exp
    MODEL_TENSOR.INDEXER_K_PROJ:            "blk.{bid}.indexer.k_proj",       # qwen4exp
    MODEL_TENSOR.INDEXER_Q_NORM:            "blk.{bid}.indexer.q_norm",       # qwen4exp
    # vision
